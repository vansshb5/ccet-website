...
const MechSyllabus = () => {
    ...
    useEffect(() => {
        const fetchSyllabus = async () => {
            try {
                ...
                // Filter the data for the 'MECH' department
                const mechSyllabus = data.filter(item => item.department === 'MECH');
                
                // Sort by year (descending) to logically assign newest to 1st year
                mechSyllabus.sort((a, b) => b.year.localeCompare(a.year) || b.id.localeCompare(a.id));

                setSyllabusData(mechSyllabus);
                setError(null);
    ...
    // Based on the data you provided earlier, the 2025 MECH syllabus is available.
        ...
        return (
            <SharedMechLayout pageTitle="Syllabus">
                <div className={styles.body}>
                    ...
                    <p>Loading Mechanical Engineering syllabus information...</p>
                </div>
            </SharedMechLayout>
        );
    }
